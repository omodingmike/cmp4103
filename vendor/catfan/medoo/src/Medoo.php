<?php
    ...
    class Medoo
    {
         ...
         */
        public function exec(string $statement, array $map = [], callable $callback = null)
        : ?PDOStatement
        {
            $this->statement = null;
            $this->errorInfo = null;
         ...
         * @return string
         */
        protected function generate(string $statement, array $map)
        : string
        {
            $identifier = [
                'mysql' => '`$1`',
         ...
         * @return \PDOStatement|null
         */
        public function create(string $table, $columns, $options = null)
        : ?PDOStatement
        {
            $stack       = [];
            $tableOption = '';
         ...
         * @return string
         */
        public function tableQuote(string $table)
        : string
        {
         ...
         * @return string
         */
        public function columnQuote(string $column)
        : string
        {
         ...
         * @return \PDOStatement|null
         */
        public function insert(string $table, array $values, string $primaryKey = null)
        : ?PDOStatement
        {
            $stack      = [];
            $columns    = [];
         ...
         * @return string|null
         */
        protected function buildRaw($raw, array &$map)
        : ?string
        {
            if (!$this->isRaw($raw)) {
                return null;
         ...
         * @return \PDOStatement|null
         */
        private function returningQuery($query, &$map, &$data)
        : ?PDOStatement
        {
         ...
         * @return string
         */
        protected function whereClause($where, array &$map)
        : string
        {
            $clause = '';
         ...
         * @return \PDOStatement|null
         */
        public function replace(string $table, array $columns, $where = null)
        : ?PDOStatement
        {
            $map   = [];
            $stack = [];
         ...
         * @return bool
         */
        protected function isJoin($join)
        : bool
        {
            if (!is_array($join)) {
                return false;
         ...
         * @return string
         */
        protected function buildJoin(string $table, array $join, array &$map)
        : string
        {
            $tableJoin = [];
            $type      = [
         ...
         * @return string
         */
        protected function columnPush(&$columns, array &$map, bool $root, bool $isJoin = false)
        : string
        {
            if ($columns === '*') {
                return $columns;
         ...
         * @return array
         */
        protected function columnMap($columns, array &$stack, bool $root)
        : array
        {
            if ($columns === '*') {
                return $stack;
         ...
         * @return bool
         */
        public function has(string $table, $join, $where = null)
        : bool
        {
            $map    = [];
            $column = null;
         ...
         * @return array
         */
        public function rand(string $table, $join = null, $columns = null, $where = null)
        : array
        {
            $orderRaw = $this->raw(
         ...
         * @return array|null
         */
        public function select(string $table, $join, $columns = null, $where = null)
        : ?array
        {
            $map       = [];
            $result    = [];
         ...
         * @return int|null
         */
        public function count(string $table, $join = null, $column = null, $where = null)
        : ?int
        {
         ...
         * @return string|null
         */
        private function aggregate(string $type, string $table, $join = null, $column = null, $where = null)
        : ?string
        {
            $map = [];
         ...
         * @return string|null
         */
        public function avg(string $table, $join, $column = null, $where = null)
        : ?string
        {
         ...
         * @return string|null
         */
        public function max(string $table, $join, $column = null, $where = null)
        : ?string
        {
         ...
         * @return string|null
         */
        public function sum(string $table, $join, $column = null, $where = null)
        : ?string
        {
         ...
         * @return string|null
         */
        public function id(string $name = null)
        : ?string
        {
            $type = $this->type;
         ...
         * @return \PDOStatement|null
         */
        public function query(string $statement, array $map = [])
        : ?PDOStatement
        {
